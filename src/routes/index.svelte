...
<script lang="ts" context="module">
	...
	*/
	export async function load({ page, fetch }) {
		...
		if (response_livescores_football && response_livescores_football_leagues && response_livescores_football_translations) {
			return {
				props: {
		...
		// ... otherwise, ERROR;
		return {
			status: response_livescores_football.status,
